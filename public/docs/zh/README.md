...
> 由于本人没有太多时间维护这个项目，laravel-admin只支持lts版本的Laravel（目前是Laravel 5.5）。
...
QQ群:278455482(已满)、635881319(已满)、533701919(已满)、821831984(新开)

> 为了避免发广告及不看文档用户，请先到github star此项目，然后附上github账号申请入群
